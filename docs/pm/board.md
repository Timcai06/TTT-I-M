...
用户方案已存档，具体建议见 [叙事内核迁移计划 DRAFT v1](narrative-runtime-plan.md)。NR-00 为 READY（依赖基线远程核验后发送）；NR-01 至 NR-08 的实施部分仍为 DRAFT。
...
- [基线记录](baselines/2026-09-09.md)：保存到 `baseline/personal-archive-20260909`；待远程核验后派发 NR-00。计划待 tim 确认，未授权实施。
