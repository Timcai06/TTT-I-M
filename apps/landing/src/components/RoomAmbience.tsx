 ...
 * meant the site's mute did not reach it. The bed is now a real recording owned by
 ...
 */
/** SoundProvider clamps to its own floor; this range only shapes how the level
 *  travels between the far wall and the opening. */
const WINDOW_FLOOR = 0
